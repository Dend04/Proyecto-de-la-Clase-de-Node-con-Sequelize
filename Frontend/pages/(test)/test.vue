  ...
  <div class="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 flex flex-col">
    ...
    >
      <div class="relative w-full max-w-6xl mx-auto px-6 py-12">
        <!-- Título -->
        <h1 class="text-4xl md:text-5xl font-bold text-gray-800 mb-12 tracking-tight text-center">
          Tests Disponibles
        </h1>
  ...
  try {
    ...
    for (const test of testsData) {
      try {
        ...
        const tienePreguntasIncompletas = preguntasConEstado.some((pregunta) => !pregunta.completa);
