  ...
  <div class="min-h-screen flex flex-col items-center justify-center p-4">
    ...
    <div v-else>
      ...
      <div v-else class="w-full max-w-4xl">
        <ul class="space-y-4">
          <li v-for="pregunta in preguntas" :key="pregunta.id" class="bg-white p-4 rounded-lg shadow-lg flex justify-between items-center">
            <h2 class="text-xl font-semibold text-gray-800">{{ pregunta.texto }}</h2>
            <NuxtLink :to="`/visualizarRespuestas/${pregunta.id}`" class="text-green-500 hover:text-green-700 ml-4" title="Visualizar respuestas">
